...
/**
 * Next.js adapter for useTableUrlState.
 * Converts ReadonlyURLSearchParams and AppRouterInstance to the hook's expected types.
 */
export function useNextTableUrlState(
  params: Omit<UseTableUrlStateParams, 'search' | 'navigate'> & {
