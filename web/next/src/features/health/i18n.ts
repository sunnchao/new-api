  ...
  en: {
    translation: {
      health: {
        ...
        trend: {
          latencyTitle: 'Latency Trend (TTFT)',
          availabilityTitle: 'Availability Trend',
          ttft: 'TTFT',
  ...
  zh: {
    translation: {
      health: {
        ...
        trend: {
          latencyTitle: '延迟趋势（TTFT）',
          availabilityTitle: '可用性趋势',
          ttft: '首字延迟',
          successRate: '成功率',
  ...
  fr: {
    translation: {
      health: {
        ...
        trend: {
          latencyTitle: 'Tendance de latence (TTFT)',
          availabilityTitle: 'Tendance de disponibilite',
          ttft: 'TTFT',
  ...
  ja: {
    translation: {
      health: {
        ...
        trend: {
          latencyTitle: '遅延トレンド（TTFT）',
          availabilityTitle: '可用性トレンド',
          ttft: 'TTFT',
          successRate: '成功率',
  ...
  ru: {
    translation: {
      health: {
        ...
        trend: {
          latencyTitle: 'Тренд задержки (TTFT)',
          availabilityTitle: 'Тренд доступности',
          ttft: 'TTFT',
  ...
  vi: {
    translation: {
      health: {
        ...
        trend: {
          latencyTitle: 'Xu huong do tre (TTFT)',
          availabilityTitle: 'Xu huong kha dung',
          ttft: 'TTFT',
