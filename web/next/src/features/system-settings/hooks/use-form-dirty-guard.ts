 ...
 * - Refresh the page
 *
 * Note: In Next.js, in-app navigation blocking is handled by
 * FormNavigationGuard component instead.
 *
...
export function useFormDirtyGuard(
  ...
  // Block in-app navigation via popstate (back/forward buttons)
