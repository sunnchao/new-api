        ...
        {editMode === 'visual' ? (
          <div className='space-y-6'>
            <GroupRatioVisualEditor
              ...
              userUnselectableGroups={form.watch('UserUnselectableGroups')}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t(
                      'JSON map of group → description for groups that exist but are hidden from users.'
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
