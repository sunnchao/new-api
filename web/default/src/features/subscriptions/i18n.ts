  ...
  zhTW: {
    translation: {
      ...
      'After enabling, the plan will be shown to users. Continue?':
        '啟用後方案將向使用者展示。確認繼續？',
      'After invalidating, this subscription will be immediately deactivated. Historical records are not affected. Continue?':
        '作廢後該訂閱將立即失效，歷史記錄不受影響。確認繼續？',
      'All Groups': '全部分組',
      'All Plans': '全部方案',
      'All Status': '全部狀態',
      'All Subscriptions': '全部訂閱',
      'Allowed Groups': '允許分組',
      'Amount Due': '應付金額',
      Anchor: '錨定週期',
      'Anchor mode resets from subscription start':
        '錨定模式從訂閱開始時間起重置',
      'Approx.': '約',
      'Approximate Times': '預估次數',
      'Balance Pay': '餘額支付',
      'Basic Info': '基本資訊',
      'Billing & Display': '計費與展示',
      'Billing Mode': '計費模式',
      Cancelled: '已取消',
      Close: '關閉',
      'Configure per-window quota limits': '配置每個時間窗口的額度限制',
      'Confirm delete': '確認刪除',
      'Confirm disable': '確認停用',
      'Confirm enable': '確認啟用',
      'Confirm invalidate': '確認作廢',
      'Confirm manual renew': '確認手動續費',
      'Create Plan': '建立方案',
      'Create new subscription plan': '建立新訂閱方案',
      'Create succeeded': '建立成功',
      'Custom (seconds)': '自訂（秒）',
      'Custom Seconds': '自訂秒數',
      Daily: '每日',
      'Daily Limit': '每日限制',
      ...
      Deleted: '已刪除',
      'Deleting will permanently remove this subscription record (including benefit details). Continue?':
        '刪除將永久移除該訂閱記錄（包含權益詳情）。確認繼續？',
      Disable: '停用',
      'Disable before deleting': '請先停用再刪除',
      'Duration Settings': '時長設定',
      'Duration Unit': '時長單位',
      'Duration Value': '時長數值',
      Edit: '編輯',
      'e.g. Basic Plan': '例如 基礎方案',
      'e.g. group1, group2': '例如 group1, group2',
      ...
      End: '結束',
      'End Time': '結束時間',
      'Enter quota in tokens': '輸入 Token 數量',
      'Enter quota in {{currency}}': '輸入 {{currency}} 金額',
      'Estimated request count for quota-based plans':
        '按額度計費方案的預估請求次數',
      Every: '每',
      Exhausted: '已耗盡',
      Expired: '已過期',
      'Failed to load subscriptions': '載入訂閱失敗',
      'Fill in the following info to create a new subscription plan':
        '填寫以下資訊以建立新訂閱方案',
      'Group Permissions': '分組權限',
      'Has been disabled': '已停用',
      'Has been enabled': '已啟用',
      'Has been invalidated': '已作廢',
      'Hourly Limit': '小時限制',
      Invalidate: '作廢',
      Invalidated: '已作廢',
      'Loading failed': '載入失敗',
      ...
      'Natural Calendar': '自然日曆',
      'Next Reset': '下次重置',
      No: '否',
      'No Limits': '無限制',
      'No Reset': '不重置',
      'No Upgrade': '不升級',
      'No Waffo Pancake product': '無 Waffo Pancake 產品',
      'No subscription plans yet': '暫無訂閱方案',
      'No subscription records': '暫無訂閱記錄',
      ...
      Pay: '支付',
      'Payment Channel': '支付渠道',
      'Payment initiated': '支付已發起',
      'Payment page opened': '支付頁面已開啟',
      'Payment request failed': '支付請求失敗',
      Plan: '方案',
      'Plan Name': '方案名稱',
      'Plan Subtitle': '方案副標題',
      'Plan Title': '方案標題',
      ...
      'Please enter plan title': '請輸入方案標題',
      'Please select a payment method': '請選擇支付方式',
      'Please select a subscription plan': '請選擇訂閱方案',
      Priority: '優先級',
      'Purchase Limit': '購買限制',
      'Purchase Subscription': '購買訂閱',
      'Purchase limit reached': '已達購買上限',
      'Purchase successful': '購買成功',
      Renew: '續費',
      'Renew Subscription': '續費訂閱',
      'Renewal successful': '續費成功',
      'No payment method available': '暫無可用支付方式',
      Pending: '待生效',
      pending: '待生效',
      'Activate Now': '立即生效',
      'Activate subscription now': '立即啟用訂閱',
      'After activation, the new subscription will start immediately. The existing active subscription keeps running in parallel until its natural expiry. Continue?':
        '啟用後新訂閱將立即開始計時，現有生效中的訂閱繼續並行運行至自然到期。是否繼續？',
      'Subscription activated': '訂閱已啟用',
      'Activation failed': '啟用失敗',
      'Scheduled to activate at': '預計生效時間',
      'Estimated expiry': '預計到期',
      ...
      Status: '狀態',
      'Stripe/Creem requires creating products on the third-party platform and entering the ID':
        'Stripe/Creem 需在第三方平台建立產品並填入 ID',
      ...
      'User Group': '使用者分組',
      'User ID': '使用者 ID',
      'User Subscription Management': '使用者訂閱管理',
      Validity: '有效期',
      'Validity Period': '有效期',
      Weekly: '每週',
      'Weekly Limit': '每週限制',
      ...
      Hourly: '每小時',
      'Models available for {{plan}}': '{{plan}} 可用的模型',
      'No enabled models match these groups yet.': '暫無啟用模型匹配這些分組。',
      'No supported models found': '未找到支援的模型',
      'Open Model Square': '開啟模型廣場',
      'Please refresh the page and try again.': '請重新整理頁面後重試。',
      'Sign in to subscribe': '登入後訂閱',
      'Supported Models': '支援的模型',
      'Unable to load supported models': '無法載入支援的模型',
      'View all models': '查看所有模型',
      'View in Model Square': '在模型廣場查看',
    },
  },
  fr: {
    translation: {
