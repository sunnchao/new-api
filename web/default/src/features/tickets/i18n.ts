const resources = {
  ...
  zhTW: {
    translation: {
      ...
      'Ticket assigned successfully': '工單分配成功',
      ...
      'Updated At': '更新時間',
      Back: '返回',
      'Are you sure you want to close this ticket?': '確定要關閉該工單嗎？',
