...
export function SubscriptionRenewDialog(props: Props) {
  ...
  const handlePayStripe = async () => {
    ...
    setPaying(true)
    try {
      const res = await payRenewStripe({ user_subscription_id: subId })
  ...
  const handlePayCreem = async () => {
    ...
    setPaying(true)
    try {
      const res = await payRenewCreem({ user_subscription_id: subId })
  ...
  const handlePayBalance = async () => {
    ...
    setPaying(true)
    try {
      const res = await payRenewBalance({ user_subscription_id: subId })
