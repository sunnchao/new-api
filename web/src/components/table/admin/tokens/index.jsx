...
import CCSwitchModal from '../../tokens/modals/CCSwitchModal';
...
function AdminTokensPage() {
  ...
  const tokensData = useTokensData(
    ...
    {
      // Admin view requests the shared token list endpoint instead of self-only data.
      listEndpoint: '/api/v1/token/list',
      listParams: { self: false },
      searchEndpoint: '/api/v1/token/list',
      searchParams: { self: false },
    },
  );
    ...
    <>
      ...
      >
        <TokensTable
          ...
          userGroup={userGroup}
          // Admin view shows token owner columns while reusing the shared table/actions.
