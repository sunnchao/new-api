            ...
            const advancedSettingsContent = (
              <div className='space-y-4'>
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch field='pass_through_header_enabled' label={t('透传请求头')} checkedText={t('开')} uncheckedText={t('关')} onChange={(value) => handleChannelSettingsChange('pass_through_header_enabled', value)} extraText={t('启用请求头透传功能')} />
