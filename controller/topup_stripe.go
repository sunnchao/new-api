...
func sessionCompleted(event stripe.Event, clientIP string) {
	...
	if err := model.CompleteSubscriptionOrder(referenceId, common.GetJsonString(payload), clientIP); err == nil {
		return
