...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminUserRoute := userRoute.Group("/")
			adminUserRoute.Use(middleware.AdminAuth())
			{
				adminUserRoute.GET("/groups", controller.GetUserGroups)
			}
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/setting/test_notify", controller.TestUserNotification)
				...
				selfRoute.GET("/gift-quota/history", middleware.DisableCache(), controller.GetUserGiftQuotaHistory)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/tokens", controller.GetUserTokens)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.GET("/all", controller.AdminListAllUserSubscriptions)
		}
