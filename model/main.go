...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&InvoiceRequestSubscriptionItem{}, "InvoiceRequestSubscriptionItem"},
...
` + "`show_on_home`" + ` numeric DEFAULT 0,
...
` + "`billing_mode`" + ` varchar(16) NOT NULL DEFAULT 'quota',
` + "`quota_reset_period`" + ` varchar(16) DEFAULT 'never',
` + "`quota_reset_mode`" + ` varchar(16) DEFAULT 'anchor',
` + "`quota_reset_custom_seconds`" + ` bigint DEFAULT 0,
` + "`hourly_limit_amount`" + ` bigint DEFAULT 0,
` + "`hourly_limit_hours`" + ` integer DEFAULT 1,
` + "`hourly_reset_mode`" + ` varchar(16) DEFAULT 'anchor',
` + "`daily_limit_amount`" + ` bigint DEFAULT 0,
` + "`daily_reset_mode`" + ` varchar(16) DEFAULT 'anchor',
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "show_on_home", DDL: "`show_on_home` numeric DEFAULT 0"},
		...
		{Name: "billing_mode", DDL: "`billing_mode` varchar(16) NOT NULL DEFAULT 'quota'"},
		{Name: "quota_reset_period", DDL: "`quota_reset_period` varchar(16) DEFAULT 'never'"},
		{Name: "quota_reset_mode", DDL: "`quota_reset_mode` varchar(16) DEFAULT 'anchor'"},
		...
		{Name: "hourly_reset_mode", DDL: "`hourly_reset_mode` varchar(16) DEFAULT 'anchor'"},
		{Name: "daily_limit_amount", DDL: "`daily_limit_amount` bigint DEFAULT 0"},
		{Name: "daily_reset_mode", DDL: "`daily_reset_mode` varchar(16) DEFAULT 'anchor'"},
